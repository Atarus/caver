...
if !place_free(instance_x-32,instance_y)
{
   // var object_left = instance_place(instance_x-32,instance_y,obj_glass)
    //if object_left = obj_glass
    //{
    if instance_place(instance_x-32,instance_y,obj_glass)
    {
    if instance_place(instance_x-32,instance_y,obj_glass).breaking > 3
    {
        make_breaking = true
    }
    }
...
if !place_free(instance_x,instance_y+32)
{
   ...
   // if object_below = obj_glass
  //  {
   if instance_place(instance_x,instance_y+32,obj_glass)
    {
    if instance_place(instance_x,instance_y+32,obj_glass).breaking > 3
    {
        make_breaking = true
    }
    }
